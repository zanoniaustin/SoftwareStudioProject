                ...
                <div>
                    ...
                    <Card className="overflow-hidden">
                        <div className="aspect-[3/4] relative">
                            <Image src={userImageUrl} alt="User uploaded card" fill className="object-contain"/>
                        </div>
                    </Card>
                </div>
                <div>
                    ...
                    <Card className="p-4 flex flex-col gap-4">
                        <div className="aspect-[3/4] relative">
                            <Image src={card.imageUrl} alt={card.name} fill className="object-contain"/>
                        </div>
                        <div>
                            <h3 className="text-2xl font-bold">{card.name}</h3>
                            <p>{card.set.name} - {card.set.number}</p>
                            <p>Rarity: {card.rarity}</p>
                            <p className="text-lg font-semibold mt-4">Est. Price: ${card.estimatedPrice}</p>
                        </div>
