        ...
        async (acceptedFiles: File[]) => {
            ...
            if (file) {
                ...
                try {
                    ...
                    // Fix: Store the large card object in sessionStorage instead of the URL
                    sessionStorage.setItem('identificationResult', JSON.stringify(result));

                    const userImageBlobUrl = URL.createObjectURL(file);
                    // We only need to pass the blob URL for the user's upload in the query
                    const query = new URLSearchParams({
                        userImage: userImageBlobUrl,
                    }).toString();
