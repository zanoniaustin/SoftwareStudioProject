...
const FilterIcon = () => (
  <svg width="16" height="16" viewBox="0 0 16 16" fill="currentColor">
    <path d="M3.5 2h9a.5.5 0 0 1 0 1h-9a.5.5 0 0 1 0-1M6 6h4a.5.5 0 0 1 0 1H6a.5.5 0 0 1 0-1m-2 4h8a.5.5 0 0 1 0 1H4a.5.5 0 0 1 0-1" />
  </svg>
);
const SearchIcon = () => (
  <svg width="16" height="16" viewBox="0 0 16 16" fill="currentColor">
    ...
    <Card className="p-6">
      <div className="text-center mb-4">
        ...
        <p className="text-sm text-text-secondary">
          Search through thousands of Pokémon cards in our database.
        </p>
      </div>
      <div className="space-y-4">
        ...
        <div className="grid grid-cols-2 gap-4">
          <button className="flex items-center justify-between w-full text-left rounded-md border border-border-color bg-white px-3 py-2 text-sm text-text-secondary shadow-sm hover:bg-gray-50">
            Set/Series <FilterIcon />
          </button>
          <button className="flex items-center justify-between w-full text-left rounded-md border border-border-color bg-white px-3 py-2 text-sm text-text-secondary shadow-sm hover:bg-gray-50">
            Rarity <FilterIcon />
          </button>
